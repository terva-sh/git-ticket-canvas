...
test('Preact inspector retains metadata, checklist, log and lifecycle operations', async ({ page, app }) => {
  ...
  await page.getByText('Acceptance criteria · add', { exact: true }).click()
  ...
  await page.getByText('Notes · add', { exact: true }).click()
  ...
  await page.getByText('Comments · add', { exact: true }).click()
